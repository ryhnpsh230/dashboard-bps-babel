...
# ======================================================================================
# THEME / CSS (Modern Glass + Better spacing + Buttons + Inputs)
# ======================================================================================
st.markdown(
    f"""
<style>
...
div[data-testid="metric-container"]:hover {{
    ...
    box-shadow: 0 16px 42px rgba(255,111,0,.16);
}}
...
with st.sidebar:
    ...
    st.caption("Versi modern • glass UI • export Excel bersih")
    st.divider()
...
# ======================================================================================
    ...
    banner("Dashboard UMKM — Google Maps", "Upload CSV hasil ekstensi → auto-clean → siap export Excel/CSV")
...
st.markdown(
    ...
    "Built with Streamlit • UI Modern Glass • Export Excel Bersih • BPS UMKM Toolkit"
    "</div>",
    unsafe_allow_html=True,
)
